...
class Agent:
    ...
    def remember(self, state, action, reward, next_state, done):
        self.memory.append((state, action, reward, next_state, done)) #pop if MAX_MEORY is reached
    ...
    def get_action(self, state):
        ...
        if END_EPSILON_DECAYING >= self.n_games >= START_EPSILON_DECAYING:
