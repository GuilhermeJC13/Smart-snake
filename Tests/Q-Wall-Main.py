...
def reiniciar():
    ...
    #message_box("You Lost", f'Score of {len(player.body)}')
    player.reset((5,5))
    os.system("aplay tetris.wav&")
...
class snake(object):
    ...
    def move(self):
        ...
        elif self.head.pos[0] >= R:
            reiniciar()
                
        elif self.head.pos[1] >= R:
            reiniciar()
...
def main():
    ...
    snack = cube(randomSnack(rows, player), color=(0, 255, 0))
